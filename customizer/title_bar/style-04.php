...
Businext_Kirki::add_field( 'theme', array(
	...
	'default'     => array(
		...
		'background-image'      => BUSINEXT_THEME_IMAGE_URI . '/title-bar-bg-case-study.jpg',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.page-title-bar-04 .heading',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-04 .insight_core_breadcrumb a:after',
			'property' => 'background-color',
		),
	),
) );
