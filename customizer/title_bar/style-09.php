<?php
$section  = 'title_bar_09';
$priority = 1;
$prefix   = 'title_bar_09_';
...
Businext_Kirki::add_field( 'theme', array(
	...
	'default'     => array(
		...
		'background-image'      => BUSINEXT_THEME_IMAGE_URI . '/title-bar-bg-09.jpg',
	...
	'output'      => array(
		array(
			'element' => '.page-title-bar-09 .page-title-bar-inner',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-09 .page-title-bar-overlay',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.page-title-bar-09 .heading',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.page-title-bar-09 .insight_core_breadcrumb li, .page-title-bar-09 .insight_core_breadcrumb li a',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-09 .insight_core_breadcrumb li',
			'property' => 'color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-09 .insight_core_breadcrumb a',
			'property' => 'color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-09 .insight_core_breadcrumb a:hover',
			'property' => 'color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-09 .insight_core_breadcrumb li + li:before',
			'property' => 'color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-09 .insight_core_breadcrumb a:after',
			'property' => 'background-color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'element'     => '.page-title-bar-09 .page-title-bar-inner .heading',
			'property'    => 'font-size',
			'units'       => 'px',
			'media_query' => Businext_Helper::get_md_media_query(),
		),
