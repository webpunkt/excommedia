...
Businext_Kirki::add_field( 'theme', array(
	...
	'default'     => array(
		...
		'background-image'      => BUSINEXT_THEME_IMAGE_URI . '/title-bar-bg-service.jpg',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-06 .page-title-bar-overlay',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-bar-06 .insight_core_breadcrumb a:after',
			'property' => 'background-color',
		),
	),
) );
