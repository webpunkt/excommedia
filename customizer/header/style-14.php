...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-14 .mini-cart .mini-cart-icon:after',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-14 .menu--primary a',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-14 .menu--primary .menu__container > li > a',
			'property' => 'background-color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
            ...
            .header-14 .menu--primary .menu__container > li.current-menu-item > a',
			'property' => 'background-color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-14 .tm-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-14.headroom--not-top .page-header-inner',
		),
	),
) );
