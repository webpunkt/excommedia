...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-05 .page-open-mobile-menu i',
			'property' => 'color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-05 .page-open-mobile-menu:hover i',
			'property' => 'color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-05 .header-below',
			'property' => 'background-color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-05 .menu--primary li > a',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			...
			.header-05 .wpml-ls-legacy-dropdown-click .wpml-ls-item-toggle,
...
Businext_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => esc_html__( 'Free Consultation', 'businext' ),
) );
