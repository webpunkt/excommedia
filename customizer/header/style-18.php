...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-18 .mini-cart .mini-cart-icon:after',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-18 .tm-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-18.headroom--not-top .page-header-inner',
		),
	),
) );
