...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-13 .page-open-mobile-menu i',
			'property' => 'color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-13 .page-open-mobile-menu:hover i',
			'property' => 'color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-13 .header-info .info-icon',
			'property' => 'color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'element'  => '.header-13 .header-below',
			'property' => 'background-color',
		),
	),
	'active_callback' => array(
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '
			.header-13 .wpml-ls-legacy-dropdown-click .wpml-ls-item-toggle,
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '
			.header-13 .wpml-ls-legacy-dropdown-click .wpml-ls-item-toggle:hover,
			.header-13 .wpml-ls-legacy-dropdown-click .wpml-ls-item-toggle:focus,
			.header-13 .wpml-ls-legacy-dropdown-click .wpml-ls-current-language:hover>a,
