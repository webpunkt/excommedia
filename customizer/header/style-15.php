...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-15 .mini-cart .mini-cart-icon:after',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-15 .menu--primary a',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-15 .menu--primary .menu__container > li > a',
			'property' => 'background-color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
            ...
            .header-15 .menu--primary .menu__container > li.current-menu-item > a',
			'property' => 'background-color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Bottom Border Color', 'businext' ),
	'description' => esc_html__( 'Controls the border bottom color for main menu items.', 'businext' ),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'default'     => '#fff',
	'output'      => array(
		array(
			'element'  => '.desktop-menu .header-15 .menu--primary .menu__container > li > a .menu-item-wrap:after',
			'property' => 'background-color',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'BUSINEXT_DEMO_BUTTON_TEXT' ) ? BUSINEXT_DEMO_BUTTON_TEXT : esc_html__( 'Buy Now $29', 'businext' ),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'BUSINEXT_DEMO_BUTTON_LINK' ) ? BUSINEXT_DEMO_BUTTON_LINK : '#',
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-15 .tm-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-15.headroom--not-top .page-header-inner',
		),
	),
) );
