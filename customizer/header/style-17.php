...
Businext_Kirki::add_field( 'theme', array(
	...
	'description' => esc_html__( 'Controls the border color.', 'businext' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'transport'   => 'auto',
	'default'     => 'rgba(216, 216, 216, 0.3)',
	'output'      => array(
		array(
			'element'  => '.header-17 .page-header-inner',
		...
		array(
			'element'  => '.header-17 .branding',
			'property' => 'border-right-color',
		),
		array(
			'element'  => '.header-17 .header-right-info',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Border Color', 'businext' ),
	'description' => esc_html__( 'Controls the border color on sticky.', 'businext' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'transport'   => 'auto',
	'default'     => 'rgba(216, 216, 216, 0.1)',
	'output'      => array(
		array(
			'element'  => '.header-17.headroom--not-top .page-header-inner',
			'property' => 'border-bottom-color',
