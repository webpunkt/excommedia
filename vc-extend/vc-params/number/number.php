 ...
 * Example
    array(
        'type'       => 'number',
        'heading'    => esc_html__( 'Number field', 'businext' ),
...
*/
if ( ! class_exists( 'Businext_VC_Number_Param' ) ) {

	class Businext_VC_Number_Param {
		...
		public function __construct() {
			if ( class_exists( 'WpbakeryShortcodeParams' ) ) {
				WpbakeryShortcodeParams::addField( 'number', array(
					$this,
					'render',
				), BUSINEXT_THEME_URI . '/vc-extend/vc-params/number/functions.js' );
			}
		}
