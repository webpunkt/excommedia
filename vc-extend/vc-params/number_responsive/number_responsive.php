...
if ( ! class_exists( 'Businext_VC_Number_Responsive' ) ) {

	class Businext_VC_Number_Responsive {
		...
		public function render() {
			...
			$sizes = array(
				'lg' => esc_html__( 'Large Device', 'businext' ),
				'md' => esc_html__( 'Medium Device', 'businext' ),
				'sm' => esc_html__( 'Small Device', 'businext' ),
				'xs' => esc_html__( 'Extra Small Device', 'businext' ),
			);
...
if ( class_exists( 'Businext_VC_Number_Responsive' ) ) {
	...
	function businext_number_responsive_settings_field( $settings, $value ) {

		$number_responsive = new Businext_VC_Number_Responsive( $settings, $value );

		return $number_responsive->render();
	}

	WpbakeryShortcodeParams::addField( 'number_responsive', 'businext_number_responsive_settings_field', BUSINEXT_THEME_URI . '/vc-extend/vc-params/number_responsive/number_responsive.js' );
}
