 ...
 * @extends  WP_Widget
 */
if ( ! class_exists( 'Businext_Widget' ) ) {
	abstract class Businext_Widget extends WP_Widget {
		...
		public function form( $instance ) {
			...
			foreach ( $this->settings as $key => $setting ) {
				...
				switch ( $setting['type'] ) {
					...
					default :
						do_action( 'businext_widget_field_' . $setting['type'], $key, $value, $setting, $instance );
						break;
				}
			}
		}
