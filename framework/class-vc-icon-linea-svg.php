...
if ( ! class_exists( 'Businext_VC_Icon_Linea_SVG' ) ) {
	class Businext_VC_Icon_Linea_SVG {
		...
		public function add_to_libraries( $libraries ) {
			$libraries[ esc_html__( 'Linea SVG', 'businext' ) ] = 'linea_svg';
		...
		public function vc_element_enqueue( $font ) {
			switch ( $font ) {
				case 'linea_svg':
					wp_enqueue_script( 'vivus', BUSINEXT_THEME_URI . '/assets/js/vivus.min.js', array( 'jquery' ), null, true );
					break;
			}
		}
		...
		function admin_enqueue_scripts() {
			...
			wp_enqueue_style( 'font-linea', BUSINEXT_THEME_URI . '/assets/fonts/linea/font-linea.min.css', null, null );
		}

		public function add_fonts( $icons ) {
			$new_icons = array(
				esc_html__( 'Arrows & Direction', 'businext' ) => array(
				...
				esc_html__( 'Basic', 'businext' )              => array(
				...
				esc_html__( 'Basic Elaboration', 'businext' )  => array(
				...
				esc_html__( 'Ecommerce', 'businext' )          => array(
				...
				esc_html__( 'Music', 'businext' )              => array(
				...
				esc_html__( 'Software', 'businext' )           => array(
				...
				esc_html__( 'Weather', 'businext' )            => array(
	...
	new Businext_VC_Icon_Linea_SVG();
}
