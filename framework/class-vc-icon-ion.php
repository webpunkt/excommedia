...
if ( ! class_exists( 'Businext_VC_Icon_Ion' ) ) {
	class Businext_VC_Icon_Ion {
		...
		public function add_to_libraries( $libraries ) {
			$libraries[ esc_html__( 'Ion', 'businext' ) ] = 'ion';
		...
		function admin_enqueue_scripts() {
			wp_enqueue_style( 'font-ion', BUSINEXT_THEME_URI . '/assets/fonts/ion/font-ion.min.css', null, null );
		}
