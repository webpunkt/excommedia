 ...
 */
class Businext_Extra_Nav_Menu_Items {
	...
	public function edit_nav_menu_walker( $walker ) {
		...
		if ( $walker === 'Walker_Nav_Menu_Edit' ) {
			$walker = 'Businext_Walker_Nav_Menu_Edit';
		}
	...
	public function update_nav_menu_item( $menu_id, $menu_item_db_id, $args ) {
		...
		if ( isset( $_REQUEST['menu-item-image_hover'] ) && is_array( $_REQUEST['menu-item-image_hover'] ) ) {
	...
	public function setup_nav_menu_item( $menu_item ) {
		...
		if ( $menu_item->image_hover !== '' ) {
			...
			$menu_item->image_hover_url = Businext_Helper::aq_resize( array(
				'url'    => $full_image_size,
				'width'  => 150,
				'height' => 999,
				'crop'   => false,
...
new Businext_Extra_Nav_Menu_Items;
