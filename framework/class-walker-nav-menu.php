...
class Businext_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( isset( $item->image_hover ) && $item->image_hover !== '' ) {
			$item_output .= '<div class="menu-item-image_hover"><img src="' . esc_url( $item->image_hover_url ) . '" width="150" height="150" alt="' . esc_attr__( 'Item image hover', 'businext' ) . '"></div>';
		}
