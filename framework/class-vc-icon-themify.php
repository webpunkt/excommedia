...
if ( ! class_exists( 'Businext_VC_Icon_Themify' ) ) {
	class Businext_VC_Icon_Themify {
		...
		public function add_to_libraries( $libraries ) {
			$libraries[ esc_html__( 'Themify', 'businext' ) ] = 'themify';
		...
		public function vc_element_enqueue( $font ) {
			switch ( $font ) {
				case 'themify':
					wp_enqueue_style( 'font-themify', BUSINEXT_THEME_URI . '/assets/fonts/themify/font-themify.min.css', null, null );
					break;
			}
		}
		...
		public function add_fonts( $icons ) {
			$new_icons = array(
				esc_html__( 'Arrows & Direction Icons', 'businext' ) => array(
				...
				esc_html__( 'Web App Icons', 'businext' )            => array(
					array( 'ti-wand' => 'wand' ),
					array( 'ti-save' => 'save' ),
				...
				esc_html__( 'Control Icons', 'businext' )            => array(
				...
				esc_html__( 'Text Editor', 'businext' )              => array(
				...
				esc_html__( 'Layout Icons', 'businext' )             => array(
				...
				esc_html__( 'Brand Icons', 'businext' )              => array(
